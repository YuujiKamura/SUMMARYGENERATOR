...
class FastThumbnailListModel(QAbstractListModel):
    def __init__(self, image_paths: list[str], thumb_size: int, parent=None):
...
class FastThumbnailListWidget(QListView):
    ...
    def set_images(self, image_paths: list[str]):
        model = FastThumbnailListModel(image_paths, self.thumb_size)
        self.setModel(model)
...
class ScanForImagesWidget(QWidget):
    ...
    def set_images(self, image_paths, bbox_dict=None):
        ...
        self.fast_thumb_list.set_images(image_paths)
